...
## Roadmap / TODO List
- [ ] **Credit Deduction**: Automatically decrement user balance upon successful SMS delivery.
- [ ] **Bulk Messaging**: Implement support for multi-recipient SMS sending in a single API call.
