...
* `Type`: (default Type=MT Mobile Terminated history)  Type=MO if you want Mobile Originated history  
...
- [X] **Inbound SMS**: Develop a routine to capture and display incoming replies from customers (Two-way SMS).
- [X] **Balance Top-up**: Extend the /balance endpoint to allow manual or automated credit additions
